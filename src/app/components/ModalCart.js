  ...
  return (
    <>
      <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className=" w-full h-[100%] lg:max-w-[900px] lg:max-h-[600px] lg:rounded-[30px] lg:fixed lg:top-[50%] lg:left-[-10%] lg:translate-x-[50%] lg:translate-y-[-50%] outline-none '">
          {/*content*/}
